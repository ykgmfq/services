...
# Package management
f install systemd caddy fcgi jq iproute bind-utils \
...
# Place the Caddy config, overwriting the package default
...
# The packaged caddy.service is enabled alongside the units we ship
systemctl enable $new_units caddy.service
